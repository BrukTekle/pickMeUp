...
class CustomAdapterFiltered(var context:Context, val rideList: ArrayList<Trip>, var img:IntArray): RecyclerView.Adapter<CustomAdapterFiltered.MyViewHolder>() {
    /**
...
//        holder?.color.append(productList[position].color)
        ...
        holder.parentLayout.setOnClickListener{
            val intentDetail=Intent(context,RideDetailChange::class.java)
